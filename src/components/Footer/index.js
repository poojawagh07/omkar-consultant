        ...
        <div className='footer-grid'>
          ...
          <div className='footer-col'>
            ...
            <div className='social-icons'>
              <a href='#' target='_blank' rel='noopener noreferrer'><img src={fblogo} alt='facebook' /></a>
              <a href='#' target='_blank' rel='noopener noreferrer'><img src={Twitter} alt='Twitter' /></a>
              <a href='#' target='_blank' rel='noopener noreferrer'><img src={Link} alt='Linkedin' /></a>
          ...
          <div className='footer-col'>
            ...
            <div className='contact-info'>
              <p>
                <img src={contact} alt='contat' /> +1 (234) 567-890
              </p>
              <p>
                <a href='#' target='_blank' rel='noopener noreferrer'><img src={mailIcon} alt='Mail-icon' /></a>
                {" "} info@omkarconsultants.com
              </p>
              <p>
                <a href='#' target='_blank' rel='noopener noreferrer'><img src={location} alt='location-icon' /></a>
